...
describe("IngresoEfectivoPage", () => {
  ...
  it("renderiza la página con título y campos", async () => {
    ...
    expect(screen.getByText(/Ingreso efectivo/i)).toBeInTheDocument();
    expect(screen.getByLabelText(/Fecha/i)).toBeInTheDocument();
    expect(screen.getByLabelText(/Corte efectivo/i)).toBeInTheDocument();
  ...
  it("carga el corte efectivo calculado automáticamente", async () => {
    ...
    const corteEfectivoInput = screen.getByLabelText(/Corte efectivo/i) as HTMLInputElement;
